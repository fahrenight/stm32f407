...
Name = Muhammet                															 **
Surname = Korkmaz																		 **
Project Name = 002_REGISTER_LED_BLINK_WITH_USER_BUTTON 									 **
Project Explain = In this code part, if you press the user button on the STM32F407 board,**
LED blinks. Every multiples of 2 LEDs are turn on and the others LEDS turn off           **
 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 	 **
*******************************************************************************************/
